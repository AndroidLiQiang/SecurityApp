...
public class RequestUtils {
     ...
     * @param observer
     */
    public static void getDemoList(Activity context, MyObserver<List<Demo>> observer) {
     ...
     * @param observer
     */
    public static void getDemoList2(Activity context, MyObserver<Demo> observer) {
        RetrofitUtils.getApiUrl()
                .getUser1("http://www.baidu.com").compose(RxHelper.observableIO2Main(context))
                .subscribe(observer);
    }
